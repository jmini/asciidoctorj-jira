...
You need to declare `fr.jmini.asciidoctorj:jira` as a dependency for the `org.asciidoctor:asciidoctor-maven-plugin` plugin.
Your `<build>` section could look like this:
